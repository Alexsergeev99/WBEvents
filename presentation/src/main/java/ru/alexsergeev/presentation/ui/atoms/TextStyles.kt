...
fun Heading1Text(modifier: Modifier = Modifier, text: String, color: Color = Color.Black) {
    Text(
        ...
        text = text,
        fontSize = 32.sp,
        fontFamily = FontFamily(Font(ru.alexsergeev.presentation.R.font.sf_pro_display_bold)),
        fontWeight = FontWeight.Bold,
        textAlign = TextAlign.Left,
        color = color,
    )
...
fun Subheading1Text(modifier: Modifier = Modifier, text: String, color: Color = Color.Black) {
    Text(
        ...
        text = text,
        fontSize = 18.sp,
        fontFamily = FontFamily(Font(ru.alexsergeev.presentation.R.font.sf_pro_display_semibold)),
...
fun Body2Text(modifier: Modifier = Modifier, text: String, color: Color = Color.Black) {
    Text(
        ...
        text = text,
        fontSize = 14.sp,
        fontFamily = FontFamily(Font(ru.alexsergeev.presentation.R.font.sf_pro_display_regular)),
